...
def run_misspec_ma1():
    ...
    for i in range(num_runs):
        ...
        elfi.SyntheticLikelihood("rbsl", m['S1'], m['S2'],
                                 adjustment="variance", name="R_BSL_V")
